...
class StateWiseTotalRecord extends Component {
  state = {
    confirmedData: {},
    activeData: {},
    recoveredData: {},
  ...
  getEachState = async () => {
    ...
    const confirmedData = {
      name: 'Confirmed',
      logo:
        'https://res.cloudinary.com/dkt4hbybq/image/upload/v1648979497/Group_gfonwk.png',
    ...
    const activeData = {
      name: 'Active',
      logo:
        'https://res.cloudinary.com/dkt4hbybq/image/upload/v1648979831/protection_1_vxlump.png',
      value: totalActive,
    }
    ...
    const recoveredData = {
      name: 'Recovered',
      logo:
        'https://res.cloudinary.com/dkt4hbybq/image/upload/v1648979912/Vector_3_ulznpd.png',
      value: totalRecovered,
    }
    const deceasedData = {
      name: 'Deceased',
      logo:
        'https://res.cloudinary.com/dkt4hbybq/image/upload/v1648980984/breathing_1_bkqoxm.png',
      value: totalDeceased,
    }
...
export default StateWiseTotalRecord
