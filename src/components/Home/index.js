    ...
    return (
      <>
        <div testid="countryWideConfirmedCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dkt4hbybq/image/upload/v1648979497/Group_gfonwk.png"
        ...
        <div testid="countryWideActiveCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dkt4hbybq/image/upload/v1648979831/protection_1_vxlump.png"
            className="stats-icon"
        ...
        <div testid="countryWideRecoveredCases" className="stats-block-column">
          ...
          <img
            src="https://res.cloudinary.com/dkt4hbybq/image/upload/v1648979912/Vector_3_ulznpd.png"
            className="stats-icon"
        ...
        <div testid="countryWideDeceasedCases" className="stats-block-column ">
          ...
          <img
            src="https://res.cloudinary.com/dkt4hbybq/image/upload/v1648980984/breathing_1_bkqoxm.png"
            className="stats-icon"
